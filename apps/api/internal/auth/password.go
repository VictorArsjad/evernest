...
// argon2id parameters. These intentionally lean conservative for a small
// personal-scale app; bump memoryKiB up if hardware allows.
const (
	argonTime    uint32 = 2
...
// VerifyPassword checks plaintext against an encoded argon2id hash in constant time.
func VerifyPassword(password, encoded string) (bool, error) {
	...
	if version != argon2.Version {
		return false, fmt.Errorf("argon2 version mismatch: got %d want %d", version, argon2.Version)
	}
